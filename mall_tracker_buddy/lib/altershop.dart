...
class UserHomepage extends StatefulWidget {
  final String Shopd,categoryd;

  const UserHomepage({Key key, this.Shopd, this.categoryd}) : super(key: key);
...
class _UserHomepageState extends State<UserHomepage> {
  ...
  get dropdownvalue => widget.categoryd;
    ...
    return Expanded(
      child: Padding(
        ...
        child: FirebaseAnimatedList(
            ...
            shrinkWrap: true,
            query:  FirebaseDatabase.instance.reference().child("ProductDetails/e11FegQJ1NTq47zTGJieKcEjUEB2").child("${widget.Shopd}").reference().orderByChild('City').equalTo('${dropdownvalue}'),
